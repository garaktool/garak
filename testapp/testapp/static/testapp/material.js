    ...
    if (this.element_) {
        ...
        if (this.drawer_) {
            ...
            if (!drawerButton) {
                ...
                drawerButton.classList.add(this.CssClasses_.DRAWER_TXT);
                drawerButton.innerHTML = "<span class='orange'>Garak</span><span>Tool</span>"
                var drawerButtonIcon = document.createElement('span');
//                drawerButtonIcon.classList.add(this.CssClasses_.ICON);
//                drawerButtonIcon.textContent = this.Constant_.MENU_ICON;
//                drawerButtonIcon.textContent = this.Constant_.MENU_TEXT;
